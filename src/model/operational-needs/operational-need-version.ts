...
export interface OperationalNeedVersionData extends BaseEntityData {
    version?: number;
    published?: boolean;
    description?: string;
}

export class OperationalNeedVersion extends BaseEntity {
    version: number;
    published: boolean;
    description: string;

    constructor(data: OperationalNeedVersionData = {}) {
        super(data);
    ...
    static fromJSON(json: any): OperationalNeedVersion {
        return new OperationalNeedVersion({
            id: json.id,
